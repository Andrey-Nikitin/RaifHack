...
class BenchmarkModel():
    ...
    def __init__(self, numerical_features: typing.List[str],
                 ...
                 model_params1: typing.Dict[str, typing.Union[str,int,float]],
                 model_params2: typing.Dict[str, typing.Union[str,int,float]]):
        ...
        model1 = LGBMRegressor(**model_params1)
        model2 = LGBMRegressor(**model_params1)
        self.model = VotingRegressor(estimators=[('lgb1', model1), ('lgb2', model2)])
